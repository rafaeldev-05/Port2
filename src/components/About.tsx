        ...
        <div className="about-content">
          <div className="about-text-wrapper">
            ...
            <div className="about-stats">
              <StatCard count={20} label="Projects" labelPt="Projetos" />
              <StatCard count={3} label="Years of Experience" labelPt="Anos de Experiência" />
              <StatCard count={30} label="Satisfied Clients" labelPt="Clientes satisfeitos" />
            </div>
          </div>
